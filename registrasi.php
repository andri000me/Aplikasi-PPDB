                ...
                <div class="p-5">
                  ...
                  <form class="user" action="controller/registrasi_control.php" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" class="form-control form-control" required ="" id="nama" placeholder="Nama Anda"
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control form-control" required ="" id="tempt_lahir" placeholder="Tempat Lahir Anda"
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">
                                ...
                                <input type="password" name="ulangi_password" id="ulangi_password" class="form-control" required ="" placeholder="Ulangi Password"
