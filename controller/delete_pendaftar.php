...
$all_pendaftar = mysqli_query($koneksi, "SELECT pendaftar.*, nilai.nilai_un, nilai.nilai_us, nilai.nilai_rata, nilai.status FROM pendaftar, nilai WHERE pendaftar.id = nilai.pendaftar_id");
