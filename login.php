                ...
                <div class="pl-5 pr-5 pt-4 pb-4">
                  ...
                  <form class="user" action="controller/login_control.php" method="POST">
                    <div class="form-group">
                      <input type="text" name="username" class="form-control form-control-user" id="username" required="" placeholder="Masukkan Username..." 
                      oninvalid="this.setCustomValidity('Masukkan username Anda!')"
                      oninput="setCustomValidity('')">
                    </div>
                    <div class="form-group">
                      <input type="password" name="password" class="form-control form-control-user " id="password" required="" placeholder="Masukkan Password..."
                  ...
                  <hr>
                  <marquee>SELAMAT DATANG DI WEBSITE PPDB ONLINE MA NU SUNAN GIRI PRIGEN | TAHUN PELAJARAN 2021/2021</marquee>
                </div>
              </div>
            </div>
          </div>
